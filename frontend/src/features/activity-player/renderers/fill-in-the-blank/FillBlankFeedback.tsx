...
type FillBlankFeedbackProps = { submitted: boolean; isCorrect: boolean | null; message: string | null; explanation: string | null; showExplanation: boolean; showImmediateFeedback: boolean }

export function FillBlankFeedback({ submitted, isCorrect, message, explanation, showExplanation, showImmediateFeedback }: FillBlankFeedbackProps) {
