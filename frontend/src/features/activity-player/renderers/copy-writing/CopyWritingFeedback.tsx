...
type CopyWritingFeedbackProps = { submitted: boolean; complete: boolean | null; message: string | null; showImmediateFeedback: boolean }

export function CopyWritingFeedback({ submitted, complete, message, showImmediateFeedback }: CopyWritingFeedbackProps) {
