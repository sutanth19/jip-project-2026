...
type ArrangeLettersFeedbackProps = {
  submitted: boolean
...
export function ArrangeLettersFeedback({ submitted, isCorrect, message, explanation, showExplanation, showImmediateFeedback }: ArrangeLettersFeedbackProps) {
