...
export function WordBuilderFeedback({ submitted, isCorrect, message, explanation, showExplanation, showImmediateFeedback }: WordBuilderFeedbackProps) {
