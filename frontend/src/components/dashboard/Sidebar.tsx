...
const navMain: NavItem[] = [
    ...
    { title: "Kelas", url: "/guru/kelas", icon: <School />, roles: ["TEACHER"] },
    { title: "Murid", url: "/guru/murid", icon: <Users />, roles: ["TEACHER"] },
    { title: "Ibu Bapa", url: "/guru/ibu-bapa", icon: <Users />, roles: ["TEACHER"] },
