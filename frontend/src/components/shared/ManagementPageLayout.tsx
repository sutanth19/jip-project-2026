...
export function ManagementPageLayout({
  ...
  return (
    <div className="mx-auto w-full max-w-7xl bg-background px-4 pb-6 pt-5 sm:px-6 lg:px-8">
      ...
      <header className={cn(showBreadcrumb ? "mt-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between" : "mt-0 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between")}>
