...
export const AUDIT_ACTIONS = [
  ...
  "DIGITAL_ACTIVITY_CREATED", "DIGITAL_ACTIVITY_UPDATED", "DIGITAL_ACTIVITY_SUBMITTED_FOR_REVIEW", "DIGITAL_ACTIVITY_RETURNED_TO_DRAFT", "DIGITAL_ACTIVITY_PUBLISHED", "DIGITAL_ACTIVITY_ARCHIVED",
...
export const AUDIT_RESOURCE_TYPES = [
  "SCHOOL", "ADMIN", "TEACHER", "TEACHER_PERMISSION_GRANT", "PARENT", "PARENT_STUDENT", "STUDENT", "STUDENT_PARENT", "CLASS", "MEDIA", "PROFILE", "AUTH", "SYSTEM", "CURRICULUM", "QUESTION_BANK", "ACTIVITY_TEMPLATE", "DIGITAL_ACTIVITY",
] as const;
